...
class CompleatedAstana extends StatefulWidget {
  final snap;
  const CompleatedAstana({Key? key, required this.snap}) : super(key: key);

  @override
  State<CompleatedAstana> createState() => _CompleatedAstanaState();
}

class _CompleatedAstanaState extends State<CompleatedAstana> {
  bool isbutton = true;
  final listStatus = [
    '',
    'В процессе: ',
