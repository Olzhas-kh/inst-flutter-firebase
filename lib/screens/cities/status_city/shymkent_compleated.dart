...
class CompleatedShymkent extends StatefulWidget {
  final snap;
  const CompleatedShymkent({Key? key, required this.snap}) : super(key: key);

  @override
  State<CompleatedShymkent> createState() => _CompleatedShymkentState();
}

class _CompleatedShymkentState extends State<CompleatedShymkent> {
  bool isbutton = true;
  final listStatus = [
    '',
    'В процессе: ',
