...
class InProgressKyzylorda extends StatefulWidget {
  final snap;
  const InProgressKyzylorda({Key? key, required this.snap}) : super(key: key);

  @override
  State<InProgressKyzylorda> createState() => _InProgressKyzylordaState();
}

class _InProgressKyzylordaState extends State<InProgressKyzylorda> {
  var userData = {};
