...
import 'package:inst_fire/screens/cities/status_city/karagandy_compleated.dart';
import 'package:inst_fire/screens/cities/status_city/karagandy_inprogress.dart';
import 'package:inst_fire/screens/cities_task_card.dart/karagandy_card.dart';
                ...
                builder: (context,
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) => KaragandyGiveTask(
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount: snapshot.data!.docs.length,
                      itemBuilder: (ctx, index) => InProgressKaragandy(
                        snap: snapshot.data!.docs[index],
                      ),
                    ),
                  );
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount: snapshot.data!.docs.length,
                      itemBuilder: (ctx, index) => CompleatedKaragandy(
                        snap: snapshot.data!.docs[index],
                      ),
                    ),
                  );
