...
class KyzylordaGiveTask extends StatefulWidget {
  final snap;
  const KyzylordaGiveTask({Key? key, required this.snap}) : super(key: key);

  @override
  State<KyzylordaGiveTask> createState() => _KyzylordaGiveTaskState();
}

class _KyzylordaGiveTaskState extends State<KyzylordaGiveTask> {
