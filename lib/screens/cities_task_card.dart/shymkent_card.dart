...
class ShymkentGiveTask extends StatefulWidget {
  final snap;
  const ShymkentGiveTask({Key? key, required this.snap}) : super(key: key);

  @override
  State<ShymkentGiveTask> createState() => _ShymkentGiveTaskState();
}

class _ShymkentGiveTaskState extends State<ShymkentGiveTask> {
