...
class ShymkentSearchScreen extends StatefulWidget {
  const ShymkentSearchScreen({Key? key}) : super(key: key);

  @override
  State<ShymkentSearchScreen> createState() => _ShymkentSearchScreenState();
}

class _ShymkentSearchScreenState extends State<ShymkentSearchScreen> {
